...
case `uname` in
  ...
  Darwin)
    ...
    ar -rv libgtest.a gtest-all.o -lboost_system
    clang++ -std=c++11 -stdlib=libc++ -isystem ${GTEST_DIR}/include -pthread config_parser_test.cc config_parser.cc ${GTEST_DIR}/src/gtest_main.cc libgtest.a -o config_parser_test -lboost_system;;
  *)
